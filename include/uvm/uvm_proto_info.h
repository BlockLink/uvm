#ifndef uvm_proto_info_h
#define uvm_proto_info_h
...
#define opstr(o) ((o)==UOP_EQ?"==":(o)==UOP_LE?"<=":(o)==UOP_LT?"<":(((o)==UOP_TEST)||((o)==UOP_TESTSET))?NULL:"?") // Lua5.1 specific
#define invopstr(o) ((o)==UOP_EQ?"~=":(o)==UOP_LE?">":(o)==UOP_LT?">=":(((o)==UOP_TEST)||((o)==UOP_TESTSET))?"not":"?") // Lua5.1 specific
