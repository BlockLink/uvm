...
namespace simplechain {
	...
	class NodeUvmChainApi : public uvm::lua::api::IUvmChainApi
	{
	public:
		//Data_getter *data_getter ;

		//NodeUvmChainApi::NodeUvmChainApi(const std::string& host, const std::string& port, const std::string& para) {
		//	data_getter = new Data_getter(host, port, para);
		//}
		/**
		...
		*/
		...
		//std::shared_ptr<contract_object> NodeUvmChainApi::get_contract_object_by_id(const std::string& contract_id);
