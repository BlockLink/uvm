...
#define LUA_MAYBE_CHANGE_STORAGE_CONTRACT_IDS_STATE_KEY "maybe_change_storage_contract_ids_state"
			...
			static int delegate_call(lua_State* L) {
				...
				// ��Ҫά��contract id stack��storage contract id stack��ʹ��target�ֽ��룬����storage�����ʹ�õ�ǰ������ջ�ĺ�Լ������
				// �޸�ջ����storage_contract_idΪ֮ǰһ���storage_contract_id���߲���
    ...
    return function()  
        ...
        return hashes[i-int_key_size], t[hashes[i-int_key_size]] 
			...
			*/
			...
			//���Ӹ���Լ������Ϣ�ķ�ʽ���Ե���������ԼAPI����ʧ�ܲ����˳����ε��ö��Ƿ��ش�����
			// [result, exit_code] = send_message(contract_address, api_name, args�� argsΪ array table
			//����ֵΪarray table [result, exit_code]   exit_code==0 ��ʾ�ɹ�
			static int send_message(lua_State *L)
			{
				...
				//����ԭ��list size// native contract ????change list??
				...
				int argidx = 0;
				int i = 0;
				while (lua_next(L, 6)) //lua_nextѹջ��ֵ��key,value
				{
					argidx++;
					//check arg type
					if (check_arg_type) {
