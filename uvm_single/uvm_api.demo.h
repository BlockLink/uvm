    ...
    namespace api {
      ...
      public:
        ...
        */
		...
		virtual std::shared_ptr<uvm::contract::native_contract_interface> create_native_contract_by_key(lua_State *L, std::string &native_contract_key, std::string &contract_address) override;
