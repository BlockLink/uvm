	...
	namespace lua {
		namespace api {
			...
			*/
			...
			std::shared_ptr<uvm::contract::native_contract_interface> DemoUvmChainApi::create_native_contract_by_key(lua_State *L, std::string &native_contract_key, std::string &contract_address) {				
					return nullptr;
			}
